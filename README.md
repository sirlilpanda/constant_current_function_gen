...
| ------------ | --- | --- |
| current_gen | [❌](https://github.com/sirlilpanda/constant_current_function_gen/actions/runs/16104430908/attempts/1#summary-45437708109)| [❌](https://github.com/sirlilpanda/constant_current_function_gen/actions/runs/16104430908/attempts/1#summary-45437708101) | 
...
This workflow will also run the design rules check on the PCB and schematic to ensure that you upload a working PCB. These reports are uploaded as summaries within the github [actions tab](https://github.com/sirlilpanda/constant_current_function_gen/actions/runs/16104430908). This template has a simple schematic PCB in it (because DRC fails on an empty PCB). Shown below is the example PCB.
